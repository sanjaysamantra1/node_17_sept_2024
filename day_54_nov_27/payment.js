...
const newPayment = async (req, res) => {
    try {
        ...
        req.body = { user_id: 'sanjay.samantra@ybl', price: 100, phone: 9861216682, name: 'sanjay' }
        ...
        const data = {
            ...
            redirectUrl: "http://localhost:4200/products",
            redirectMode: "REDIRECT",
            callbackUrl: 'http://localhost:4200/products',
            redirectMode: 'POST',
            mobileNumber: phone,
            paymentInstrument: {
                type: 'PAY_PAGE'
